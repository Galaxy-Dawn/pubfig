...
_GALLERY_ROWS: tuple[tuple[str, ...], ...] = (
    ...
    ("07b_ecdf", "07c_qq", "08_strip", "08b_raincloud"),
    ("09_ridgeline", "10_line", "11_line_ci", "12_area"),
    ("13_scatter", "14_bubble", "15_contour2d", "15b_hexbin"),
    ("15c_bland_altman", "16_paired", "16b_dumbbell", "16c_forest_plot"),
    ("16d_grouped_scatter", "16e_donut", "16f_stacked_ratio_barh", "16j_upset"),
    ...
    ("24_roc", "24b_calibration", "25_pr_curve", "25b_volcano"),
    ("26_sankey", "27_parallel_coords"),
)
