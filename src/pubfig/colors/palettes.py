...
# Nature-inspired palette (ggsci NPG-derived community palette)
NATURE: list[str] = [
...
# Science-inspired palette (ggsci AAAS/Science-derived community palette)
SCIENCE: list[str] = [
...
# Lancet-inspired palette (ggsci Lancet-derived community palette)
LANCET: list[str] = [
...
# JAMA-inspired palette (ggsci JAMA-derived community palette)
JAMA: list[str] = [
    "#374E55", "#DF8F44", "#00A1D5", "#B24745",
    "#79AF97", "#6A6599", "#80796B",
]

# Default palette (currently same as the Nature-inspired community palette)
